...
for filename in filelist_train:
    ...
    if os.path.exists(os.path.join(args.rootdir, filename_txt)):
        if os.path.exists(os.path.join(args.rootdir, filename_labels)):
            ...
            print(wred(f'Error -- label file does not exists: {os.path.join(args.rootdir,  filename_labels)}'))
    else:
        print(wred(f'Error -- points file does not exists: {os.path.join(args.rootdir,  filename_txt)}'))
