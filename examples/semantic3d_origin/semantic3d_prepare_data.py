...
for filename in filelist_train:
    ...
    if os.path.exists(os.path.join(args.rootdir, "TEST", filename_txt)):
        if os.path.exists(os.path.join(args.rootdir, "TEST", filename_labels)):
            ...
            Sem3D.semantic3d_load_from_txt_voxel_labels(os.path.join(args.rootdir, "TEST", filename_txt),
                                                        os.path.join(args.rootdir, "TEST", filename_labels),
